package com.lumen.fastivr.IVRMLT.Dto;

import com.lumen.fastivr.IVRDto.LOSDB.CTelephone;
import com.lumen.fastivr.IVRMLT.entity.IvrMltSession;

public class CTelephoneBuilderMlt {
	
	private CTelephone telephone;
	private IvrMltSession session;
	
	public CTelephoneBuilderMlt() {
		// TODO Auto-generated constructor stub
	}
	
	private CTelephoneBuilderMlt(IvrMltSession session) {
		this.session =  session;
		telephone = new CTelephone();
	}
	
	public static CTelephoneBuilderMlt newBuilder(IvrMltSession session) {
		return new CTelephoneBuilderMlt(session);
	}

	public CTelephoneBuilderMlt setTelephone(String ckid) {
		String npa = "";
		String nxx = "";
		String lineNumber = "";
